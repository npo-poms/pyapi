...
[source, bash]
----
docker run -it  -v ~/conf:/root/conf mihxil/npo-pyapi:alpine-latest npo_mediabackend POMS_VPRO_729992
----
...
..bash_profile
-----
alias pydocker="docker run -it  -v ~/conf:/root/conf mihxil/npo-pyapi:alpine-latest"
-----
And then all tools are available like so:
[source, bash]
----
# frontend
pydocker media_get  --help
pydocker media_changes  --help
pydocker media_follow_changes  --help
pydocker media_iterate  --help
pydocker media_search  --help
pydocker pages_get  --help
pydocker pages_search  --help
pydocker schedule_get  --help
pydocker schedule_search  --help
pydocker check_credentials  --help

#backend
pydocker mediabackend  --help
pydocker mediabackend_get  --help
pydocker pagesbackend  --help
----
