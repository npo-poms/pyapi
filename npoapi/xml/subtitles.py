...
# Generated 2021-08-24 16:05:29.399375 by PyXB version 1.2.6 using Python 3.8.2.final.0
...
class subtitlesFormatEnum (pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('https://rs-test-os.poms.omroep.nl/v1/schema/urn:vpro:media:subtitles:2009', 33, 2)
    _Documentation = None
...
class subtitlesType (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('https://rs-test-os.poms.omroep.nl/v1/schema/urn:vpro:media:subtitles:2009', 9, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {urn:vpro:media:subtitles:2009}content uses Python identifier content_
    __content = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'content'), 'content_', '__urnvpromediasubtitles2009_subtitlesType_urnvpromediasubtitles2009content', False, pyxb.utils.utility.Location('https://rs-test-os.poms.omroep.nl/v1/schema/urn:vpro:media:subtitles:2009', 11, 6), )
    ...
    __lang._UseLocation = pyxb.utils.utility.Location('https://rs-test-os.poms.omroep.nl/v1/schema/urn:vpro:media:subtitles:2009', 18, 4)
    ...
    __mid._DeclarationLocation = pyxb.utils.utility.Location('https://rs-test-os.poms.omroep.nl/v1/schema/urn:vpro:media:subtitles:2009', 13, 4)
    __mid._UseLocation = pyxb.utils.utility.Location('https://rs-test-os.poms.omroep.nl/v1/schema/urn:vpro:media:subtitles:2009', 13, 4)
    ...
    __offset._DeclarationLocation = pyxb.utils.utility.Location('https://rs-test-os.poms.omroep.nl/v1/schema/urn:vpro:media:subtitles:2009', 14, 4)
    __offset._UseLocation = pyxb.utils.utility.Location('https://rs-test-os.poms.omroep.nl/v1/schema/urn:vpro:media:subtitles:2009', 14, 4)
    ...
    __creationDate._DeclarationLocation = pyxb.utils.utility.Location('https://rs-test-os.poms.omroep.nl/v1/schema/urn:vpro:media:subtitles:2009', 15, 4)
    __creationDate._UseLocation = pyxb.utils.utility.Location('https://rs-test-os.poms.omroep.nl/v1/schema/urn:vpro:media:subtitles:2009', 15, 4)
    ...
    __lastModified._DeclarationLocation = pyxb.utils.utility.Location('https://rs-test-os.poms.omroep.nl/v1/schema/urn:vpro:media:subtitles:2009', 16, 4)
    __lastModified._UseLocation = pyxb.utils.utility.Location('https://rs-test-os.poms.omroep.nl/v1/schema/urn:vpro:media:subtitles:2009', 16, 4)
    ...
    __type._DeclarationLocation = pyxb.utils.utility.Location('https://rs-test-os.poms.omroep.nl/v1/schema/urn:vpro:media:subtitles:2009', 17, 4)
    __type._UseLocation = pyxb.utils.utility.Location('https://rs-test-os.poms.omroep.nl/v1/schema/urn:vpro:media:subtitles:2009', 17, 4)
    ...
    __owner._DeclarationLocation = pyxb.utils.utility.Location('https://rs-test-os.poms.omroep.nl/v1/schema/urn:vpro:media:subtitles:2009', 19, 4)
    __owner._UseLocation = pyxb.utils.utility.Location('https://rs-test-os.poms.omroep.nl/v1/schema/urn:vpro:media:subtitles:2009', 19, 4)
    ...
    __workflow._DeclarationLocation = pyxb.utils.utility.Location('https://rs-test-os.poms.omroep.nl/v1/schema/urn:vpro:media:subtitles:2009', 20, 4)
    __workflow._UseLocation = pyxb.utils.utility.Location('https://rs-test-os.poms.omroep.nl/v1/schema/urn:vpro:media:subtitles:2009', 20, 4)
    ...
    __cueCount._DeclarationLocation = pyxb.utils.utility.Location('https://rs-test-os.poms.omroep.nl/v1/schema/urn:vpro:media:subtitles:2009', 21, 4)
    __cueCount._UseLocation = pyxb.utils.utility.Location('https://rs-test-os.poms.omroep.nl/v1/schema/urn:vpro:media:subtitles:2009', 21, 4)
...
class subtitlesContentType (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('https://rs-test-os.poms.omroep.nl/v1/schema/urn:vpro:media:subtitles:2009', 24, 2)
    _ElementMap = {}
    _AttributeMap = {}
    ...
    __format._DeclarationLocation = pyxb.utils.utility.Location('https://rs-test-os.poms.omroep.nl/v1/schema/urn:vpro:media:subtitles:2009', 27, 8)
    __format._UseLocation = pyxb.utils.utility.Location('https://rs-test-os.poms.omroep.nl/v1/schema/urn:vpro:media:subtitles:2009', 27, 8)
    ...
    __charset._DeclarationLocation = pyxb.utils.utility.Location('https://rs-test-os.poms.omroep.nl/v1/schema/urn:vpro:media:subtitles:2009', 28, 8)
    __charset._UseLocation = pyxb.utils.utility.Location('https://rs-test-os.poms.omroep.nl/v1/schema/urn:vpro:media:subtitles:2009', 28, 8)
...
subtitles = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'subtitles'), subtitlesType, location=pyxb.utils.utility.Location('https://rs-test-os.poms.omroep.nl/v1/schema/urn:vpro:media:subtitles:2009', 7, 2))
Namespace.addCategoryObject('elementBinding', subtitles.name().localName(), subtitles)



subtitlesType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'content'), subtitlesContentType, scope=subtitlesType, location=pyxb.utils.utility.Location('https://rs-test-os.poms.omroep.nl/v1/schema/urn:vpro:media:subtitles:2009', 11, 6)))
...
def _BuildAutomaton ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(subtitlesType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'content')), pyxb.utils.utility.Location('https://rs-test-os.poms.omroep.nl/v1/schema/urn:vpro:media:subtitles:2009', 11, 6))
