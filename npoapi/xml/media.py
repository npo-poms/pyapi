...
# Generated 2018-01-21 16:39:33.871516 by PyXB version 1.2.6 using Python 3.5.2.final.0
...
class streamingStatus (pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _Documentation = None
streamingStatus._CF_enumeration = pyxb.binding.facets.CF_enumeration(value_datatype=streamingStatus, enum_prefix=None)
