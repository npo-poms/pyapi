...
# Generated 2019-12-13 16:26:24.573147 by PyXB version 1.2.6 using Python 3.7.2.final.0
...
class collectionType (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('https://poms-dev.omroep.nl/schema/absentnamespace.xsd', 7, 2)
    _ElementMap = {}
    _AttributeMap = {}
...
collection = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'collection'), collectionType, location=pyxb.utils.utility.Location('https://poms-dev.omroep.nl/schema/absentnamespace.xsd', 5, 2))
...
def _BuildAutomaton ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('https://poms-dev.omroep.nl/schema/absentnamespace.xsd', 9, 6))
    counters.add(cc_0)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.WildcardUse(pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_lax, namespace_constraint=(pyxb.binding.content.Wildcard.NC_not, None)), pyxb.utils.utility.Location('https://poms-dev.omroep.nl/schema/absentnamespace.xsd', 9, 6))
