...
# Generated 2017-04-11 17:01:35.945119 by PyXB version 1.2.5 using Python 3.5.0.final.0
...
class licenseEnum (pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('http://poms-dev.omroep.nl/schema/vproShared.xsd', 90, 2)
    _Documentation = None
