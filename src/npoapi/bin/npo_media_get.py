...
def media_get():
    ...
    client.add_argument(
        "-s", "--sort", type=str, default=None, choices={"asc", "desc"}, help="sort (only relevant when using sub)"
    )
    client.add_argument(
        "-M",
        "--multiple",
    ...
    client.add_argument("-m", "--max", type=int, default=None, help="max (only relevant when using sub)")
    client.add_argument("-o", "--offset", type=int, default=None, help="offset (only relevant when using sub)")
