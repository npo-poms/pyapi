...
class subtitlesFormatEnum(pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:media:subtitles:2009", 33, 2
    )
    _Documentation = None


subtitlesFormatEnum._CF_enumeration = pyxb.binding.facets.CF_enumeration(
    value_datatype=subtitlesFormatEnum, enum_prefix=None
)
...
class subtitlesType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:media:subtitles:2009", 9, 2
    )
    _ElementMap = {}
    _AttributeMap = {}
    ...
    __content = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "content"),
        "content_",
        "__urnvpromediasubtitles2009_subtitlesType_urnvpromediasubtitles2009content",
        False,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:media:subtitles:2009", 11, 6),
    )
    ...
    __lang = pyxb.binding.content.AttributeUse(
        ...
        "lang",
        "__urnvpromediasubtitles2009_subtitlesType_httpwww_w3_orgXML1998namespacelang",
        pyxb.binding.xml_.STD_ANON_lang,
    )
    __lang._DeclarationLocation = None
    __lang._UseLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:media:subtitles:2009", 18, 4
    )
    ...
    __mid = pyxb.binding.content.AttributeUse(
        ...
        "mid",
        "__urnvpromediasubtitles2009_subtitlesType_mid",
        pyxb.binding.datatypes.string,
        required=True,
    )
    __mid._DeclarationLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:media:subtitles:2009", 13, 4
    )
    ...
    __offset = pyxb.binding.content.AttributeUse(
        ...
        "offset",
        "__urnvpromediasubtitles2009_subtitlesType_offset",
        pyxb.binding.datatypes.duration,
    )
    __offset._DeclarationLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:media:subtitles:2009", 14, 4
    )
    ...
    __creationDate = pyxb.binding.content.AttributeUse(
        ...
        "creationDate",
        "__urnvpromediasubtitles2009_subtitlesType_creationDate",
        pyxb.binding.datatypes.dateTime,
    )
    __creationDate._DeclarationLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:media:subtitles:2009", 15, 4
    )
    ...
    __lastModified = pyxb.binding.content.AttributeUse(
        ...
        "lastModified",
        "__urnvpromediasubtitles2009_subtitlesType_lastModified",
        pyxb.binding.datatypes.dateTime,
    )
    __lastModified._DeclarationLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:media:subtitles:2009", 16, 4
    )
    ...
    __type = pyxb.binding.content.AttributeUse(
        ...
        "type",
        "__urnvpromediasubtitles2009_subtitlesType_type",
        _ImportedBinding_npoapi_xml_shared.subtitlesTypeEnum,
    )
    __type._DeclarationLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:media:subtitles:2009", 17, 4
    )
    ...
    __owner = pyxb.binding.content.AttributeUse(
        ...
        "owner",
        "__urnvpromediasubtitles2009_subtitlesType_owner",
        _ImportedBinding_npoapi_xml_shared.ownerTypeEnum,
    )
    __owner._DeclarationLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:media:subtitles:2009", 19, 4
    )
    ...
    __workflow = pyxb.binding.content.AttributeUse(
        ...
        "workflow",
        "__urnvpromediasubtitles2009_subtitlesType_workflow",
        _ImportedBinding_npoapi_xml_shared.subtitlesWorkflowEnum,
    )
    __workflow._DeclarationLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:media:subtitles:2009", 20, 4
    )
    ...
    __cueCount = pyxb.binding.content.AttributeUse(
        pyxb.namespace.ExpandedName(None, "cueCount"),
        "cueCount",
        "__urnvpromediasubtitles2009_subtitlesType_cueCount",
        pyxb.binding.datatypes.int,
    )
    __cueCount._DeclarationLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:media:subtitles:2009", 21, 4
    )
    __cueCount._UseLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:media:subtitles:2009", 21, 4
    )

    cueCount = property(__cueCount.value, __cueCount.set, None, None)

    _ElementMap.update({__content.name(): __content})
...
class subtitlesContentType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:media:subtitles:2009", 24, 2
    )
    _ElementMap = {}
    _AttributeMap = {}
    ...
    __format = pyxb.binding.content.AttributeUse(
        ...
        "format",
        "__urnvpromediasubtitles2009_subtitlesContentType_format",
        _module_typeBindings.subtitlesFormatEnum,
    )
    __format._DeclarationLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:media:subtitles:2009", 27, 8
    )
    ...
    __charset = pyxb.binding.content.AttributeUse(
        pyxb.namespace.ExpandedName(None, "charset"),
        "charset",
        "__urnvpromediasubtitles2009_subtitlesContentType_charset",
        pyxb.binding.datatypes.string,
    )
    __charset._DeclarationLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:media:subtitles:2009", 28, 8
    )
    __charset._UseLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:media:subtitles:2009", 28, 8
    )
    ...
    _ElementMap.update({})
    _AttributeMap.update({__format.name(): __format, __charset.name(): __charset})
...
subtitles = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "subtitles"),
    subtitlesType,
    location=pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:media:subtitles:2009", 7, 2
    ),
)
Namespace.addCategoryObject("elementBinding", subtitles.name().localName(), subtitles)


subtitlesType._AddElement(
    pyxb.binding.basis.element(
        pyxb.namespace.ExpandedName(Namespace, "content"),
        subtitlesContentType,
        scope=subtitlesType,
        location=pyxb.utils.utility.Location(
            "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:media:subtitles:2009", 11, 6
        ),
    )
)
...
def _BuildAutomaton():
    ...
    symbol = pyxb.binding.content.ElementUse(
        subtitlesType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "content")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:media:subtitles:2009", 11, 6),
    )
