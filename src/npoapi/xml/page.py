...
class CTD_ANON(pyxb.binding.basis.complexTypeDefinition):
    ...
    __paragraph = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "paragraph"),
        "paragraph",
        "__urnvpropages2013_CTD_ANON_urnvpropages2013paragraph",
        True,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 25, 12),
    )

    paragraph = property(__paragraph.value, __paragraph.set, None, None)

    _ElementMap.update({__paragraph.name(): __paragraph})
...
class CTD_ANON_(pyxb.binding.basis.complexTypeDefinition):
    ...
    __image = pyxb.binding.content.ElementDeclaration(
        ...
        "image",
        "__urnvpropages2013_CTD_ANON__urnvpropages2013image",
        True,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 37, 12),
    )
...
class portalType(pyxb.binding.basis.complexTypeDefinition):
    ...
    __name = pyxb.binding.content.ElementDeclaration(
        ...
        "name",
        "__urnvpropages2013_portalType_urnvpropages2013name",
        False,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 57, 6),
    )

    name = property(__name.value, __name.set, None, None)

    # Element {urn:vpro:pages:2013}section uses Python identifier section
    __section = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "section"),
        "section",
        "__urnvpropages2013_portalType_urnvpropages2013section",
        False,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 58, 6),
    )
    ...
    __id = pyxb.binding.content.AttributeUse(
        ...
        "id",
        "__urnvpropages2013_portalType_id",
        pyxb.binding.datatypes.string,
        required=True,
    )
    __id._DeclarationLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 60, 4
    )
    ...
    __url = pyxb.binding.content.AttributeUse(
        pyxb.namespace.ExpandedName(None, "url"),
        "url",
        "__urnvpropages2013_portalType_url",
        pyxb.binding.datatypes.string,
        required=True,
    )
    __url._DeclarationLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 61, 4
    )
    __url._UseLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 61, 4
    )

    url = property(__url.value, __url.set, None, None)

    _ElementMap.update({__name.name(): __name, __section.name(): __section})
    _AttributeMap.update({__id.name(): __id, __url.name(): __url})
...
class sectionType(pyxb.binding.basis.complexTypeDefinition):
    ...
    __path = pyxb.binding.content.AttributeUse(
        pyxb.namespace.ExpandedName(None, "path"),
        "path",
        "__urnvpropages2013_sectionType_path",
        pyxb.binding.datatypes.string,
    )
    __path._DeclarationLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 67, 8
    )
    __path._UseLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 67, 8
    )
    ...
    _ElementMap.update({})
    _AttributeMap.update({__path.name(): __path})
...
class genreType(pyxb.binding.basis.complexTypeDefinition):
    ...
    __term = pyxb.binding.content.ElementDeclaration(
        ...
        "term",
        "__urnvpropages2013_genreType_urnvpropages2013term",
        True,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 74, 6),
    )

    term = property(__term.value, __term.set, None, None)

    # Attribute displayName uses Python identifier displayName
    __displayName = pyxb.binding.content.AttributeUse(
        pyxb.namespace.ExpandedName(None, "displayName"),
        "displayName",
        "__urnvpropages2013_genreType_displayName",
        pyxb.binding.datatypes.string,
    )
    __displayName._DeclarationLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 76, 4
    )
    __displayName._UseLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 76, 4
    )
    ...
    # Attribute id uses Python identifier id
    __id = pyxb.binding.content.AttributeUse(
        pyxb.namespace.ExpandedName(None, "id"), "id", "__urnvpropages2013_genreType_id", pyxb.binding.datatypes.string
    )
    __id._DeclarationLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 77, 4
    )
    __id._UseLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 77, 4
    )
    ...
    _AttributeMap.update({__displayName.name(): __displayName, __id.name(): __id})
...
class paragraphType(pyxb.binding.basis.complexTypeDefinition):
    ...
    __title = pyxb.binding.content.ElementDeclaration(
        ...
        "title",
        "__urnvpropages2013_paragraphType_urnvpropages2013title",
        False,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 86, 6),
    )

    title = property(__title.value, __title.set, None, None)

    # Element {urn:vpro:pages:2013}body uses Python identifier body
    __body = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "body"),
        "body",
        "__urnvpropages2013_paragraphType_urnvpropages2013body",
        False,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 87, 6),
    )
    ...
    __image = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "image"),
        "image",
        "__urnvpropages2013_paragraphType_urnvpropages2013image",
        False,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 88, 6),
    )

    image = property(__image.value, __image.set, None, None)

    _ElementMap.update({__title.name(): __title, __body.name(): __body, __image.name(): __image})
    _AttributeMap.update({})
...
class embedType(pyxb.binding.basis.complexTypeDefinition):
    ...
    __program = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(_Namespace_media, "program"),
        "program",
        "__urnvpropages2013_embedType_urnvpromedia2009program",
        False,
    ...
    __group = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(_Namespace_media, "group"),
        "group",
        "__urnvpropages2013_embedType_urnvpromedia2009group",
        False,
    ...
    __segment = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(_Namespace_media, "segment"),
        "segment",
        "__urnvpropages2013_embedType_urnvpromedia2009segment",
        False,
        pyxb.utils.utility.Location("https://poms-test.omroep.nl/schema/vproMedia.xsd", 39, 2),
    )
    ...
    __title = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "title"),
        "title",
        "__urnvpropages2013_embedType_urnvpropages2013title",
        False,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 124, 6),
    )
    ...
    __description = pyxb.binding.content.ElementDeclaration(
        ...
        "description",
        "__urnvpropages2013_embedType_urnvpropages2013description",
        False,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 125, 6),
    )
...
class relationType(pyxb.binding.basis.complexTypeDefinition):
    ...
    __uriRef = pyxb.binding.content.AttributeUse(
        ...
        "uriRef",
        "__urnvpropages2013_relationType_uriRef",
        pyxb.binding.datatypes.string,
    )
    __uriRef._DeclarationLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 137, 8
    )
    ...
    __broadcaster = pyxb.binding.content.AttributeUse(
        ...
        "broadcaster",
        "__urnvpropages2013_relationType_broadcaster",
        pyxb.binding.datatypes.string,
        required=True,
    )
    __broadcaster._DeclarationLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 138, 8
    )
    ...
    __type = pyxb.binding.content.AttributeUse(
        ...
        "type",
        "__urnvpropages2013_relationType_type",
        pyxb.binding.datatypes.string,
        required=True,
    )
    __type._DeclarationLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 139, 8
    )
    ...
    _ElementMap.update({})
    _AttributeMap.update({__uriRef.name(): __uriRef, __broadcaster.name(): __broadcaster, __type.name(): __type})
...
class pageType(pyxb.binding.basis.complexTypeDefinition):
    ...
    __genre = pyxb.binding.content.ElementDeclaration(
        ...
        "genre",
        "__urnvpropages2013_pageType_urnvpropages2013genre",
        True,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 7, 2),
    )
    ...
    __crid = pyxb.binding.content.ElementDeclaration(
        ...
        "crid",
        "__urnvpropages2013_pageType_urnvpropages2013crid",
        True,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 13, 6),
    )
    ...
    __alternativeUrl = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "alternativeUrl"),
        "alternativeUrl",
        "__urnvpropages2013_pageType_urnvpropages2013alternativeUrl",
        True,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 14, 6),
    )
    ...
    __broadcaster = pyxb.binding.content.ElementDeclaration(
        ...
        "broadcaster",
        "__urnvpropages2013_pageType_urnvpropages2013broadcaster",
        True,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 15, 6),
    )
    ...
    __portal = pyxb.binding.content.ElementDeclaration(
        ...
        "portal",
        "__urnvpropages2013_pageType_urnvpropages2013portal",
        False,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 16, 6),
    )
    ...
    __title = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "title"),
        "title",
        "__urnvpropages2013_pageType_urnvpropages2013title",
        False,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 17, 6),
    )
    ...
    __subTitle = pyxb.binding.content.ElementDeclaration(
        ...
        "subTitle",
        "__urnvpropages2013_pageType_urnvpropages2013subTitle",
        False,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 18, 6),
    )
    ...
    __keyword = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "keyword"),
        "keyword",
        "__urnvpropages2013_pageType_urnvpropages2013keyword",
        True,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 19, 6),
    )
    ...
    __summary = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "summary"),
        "summary",
        "__urnvpropages2013_pageType_urnvpropages2013summary",
        False,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 21, 6),
    )
    ...
    __paragraphs = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "paragraphs"),
        "paragraphs",
        "__urnvpropages2013_pageType_urnvpropages2013paragraphs",
        False,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 22, 6),
    )
    ...
    __tag = pyxb.binding.content.ElementDeclaration(
        ...
        "tag",
        "__urnvpropages2013_pageType_urnvpropages2013tag",
        True,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 29, 6),
    )

    tag = property(__tag.value, __tag.set, None, None)

    # Element {urn:vpro:pages:2013}referral uses Python identifier referral
    __referral = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "referral"),
        "referral",
        "__urnvpropages2013_pageType_urnvpropages2013referral",
        True,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 30, 6),
    )
    ...
    __link = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "link"),
        "link",
        "__urnvpropages2013_pageType_urnvpropages2013link",
        True,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 31, 6),
    )

    link = property(__link.value, __link.set, None, None)

    # Element {urn:vpro:pages:2013}embed uses Python identifier embed
    __embed = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "embed"),
        "embed",
        "__urnvpropages2013_pageType_urnvpropages2013embed",
        True,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 32, 6),
    )

    embed = property(__embed.value, __embed.set, None, None)

    # Element {urn:vpro:pages:2013}statRef uses Python identifier statRef
    __statRef = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "statRef"),
        "statRef",
        "__urnvpropages2013_pageType_urnvpropages2013statRef",
        True,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 33, 6),
    )
    ...
    __images = pyxb.binding.content.ElementDeclaration(
        ...
        "images",
        "__urnvpropages2013_pageType_urnvpropages2013images",
        False,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 34, 6),
    )
    ...
    __relation = pyxb.binding.content.ElementDeclaration(
        ...
        "relation",
        "__urnvpropages2013_pageType_urnvpropages2013relation",
        True,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 41, 6),
    )
    ...
    __url = pyxb.binding.content.AttributeUse(
        pyxb.namespace.ExpandedName(None, "url"),
        "url",
        "__urnvpropages2013_pageType_url",
        pyxb.binding.datatypes.string,
        required=True,
    )
    __url._DeclarationLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 43, 4
    )
    __url._UseLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 43, 4
    )
    ...
    __type = pyxb.binding.content.AttributeUse(
        pyxb.namespace.ExpandedName(None, "type"),
        "type",
        "__urnvpropages2013_pageType_type",
        _module_typeBindings.pageTypeEnum,
        required=True,
    )
    __type._DeclarationLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 44, 4
    )
    __type._UseLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 44, 4
    )
    ...
    __creationDate = pyxb.binding.content.AttributeUse(
        ...
        "creationDate",
        "__urnvpropages2013_pageType_creationDate",
        pyxb.binding.datatypes.dateTime,
    )
    __creationDate._DeclarationLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 45, 4
    )
    ...
    __lastModified = pyxb.binding.content.AttributeUse(
        ...
        "lastModified",
        "__urnvpropages2013_pageType_lastModified",
        pyxb.binding.datatypes.dateTime,
    )
    __lastModified._DeclarationLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 46, 4
    )
    ...
    __lastPublished = pyxb.binding.content.AttributeUse(
        pyxb.namespace.ExpandedName(None, "lastPublished"),
        "lastPublished",
        "__urnvpropages2013_pageType_lastPublished",
        pyxb.binding.datatypes.dateTime,
    )
    __lastPublished._DeclarationLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 47, 4
    )
    __lastPublished._UseLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 47, 4
    )
    ...
    __publishStart = pyxb.binding.content.AttributeUse(
        ...
        "publishStart",
        "__urnvpropages2013_pageType_publishStart",
        pyxb.binding.datatypes.dateTime,
    )
    __publishStart._DeclarationLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 48, 4
    )
    ...
    __publishStop = pyxb.binding.content.AttributeUse(
        ...
        "publishStop",
        "__urnvpropages2013_pageType_publishStop",
        pyxb.binding.datatypes.dateTime,
    )
    __publishStop._DeclarationLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 49, 4
    )
    ...
    __refCount = pyxb.binding.content.AttributeUse(
        pyxb.namespace.ExpandedName(None, "refCount"),
        "refCount",
        "__urnvpropages2013_pageType_refCount",
        pyxb.binding.datatypes.int,
    )
    __refCount._DeclarationLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 50, 4
    )
    __refCount._UseLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 50, 4
    )
    ...
    __sortDate = pyxb.binding.content.AttributeUse(
        ...
        "sortDate",
        "__urnvpropages2013_pageType_sortDate",
        pyxb.binding.datatypes.dateTime,
    )
    __sortDate._DeclarationLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 51, 4
    )
    __sortDate._UseLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 51, 4
    )
    ...
    __workflow = pyxb.binding.content.AttributeUse(
        ...
        "workflow",
        "__urnvpropages2013_pageType_workflow",
        _module_typeBindings.pageWorkflow,
    )
    __workflow._DeclarationLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 52, 4
    )
...
class imageType(pyxb.binding.basis.complexTypeDefinition):
    ...
    __title = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "title"),
        "title",
        "__urnvpropages2013_imageType_urnvpropages2013title",
        False,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 94, 6),
    )
    ...
    __description = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "description"),
        "description",
        "__urnvpropages2013_imageType_urnvpropages2013description",
        False,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 95, 6),
    )
    ...
    __credits = pyxb.binding.content.ElementDeclaration(
        ...
        "credits",
        "__urnvpropages2013_imageType_urnvpropages2013credits",
        False,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 96, 6),
    )
    ...
    __source = pyxb.binding.content.ElementDeclaration(
        ...
        "source",
        "__urnvpropages2013_imageType_urnvpropages2013source",
        False,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 97, 6),
    )
    ...
    __sourceName = pyxb.binding.content.ElementDeclaration(
        ...
        "sourceName",
        "__urnvpropages2013_imageType_urnvpropages2013sourceName",
        False,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 98, 6),
    )
    ...
    __license = pyxb.binding.content.ElementDeclaration(
        ...
        "license",
        "__urnvpropages2013_imageType_urnvpropages2013license",
        False,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 99, 6),
    )
    ...
    __type = pyxb.binding.content.AttributeUse(
        pyxb.namespace.ExpandedName(None, "type"),
        "type",
        "__urnvpropages2013_imageType_type",
        _ImportedBinding_npoapi_xml_shared.imageTypeEnum,
    )
    __type._DeclarationLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 101, 4
    )
    __type._UseLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 101, 4
    )
    ...
    __url = pyxb.binding.content.AttributeUse(
        pyxb.namespace.ExpandedName(None, "url"),
        "url",
        "__urnvpropages2013_imageType_url",
        pyxb.binding.datatypes.string,
    )
    __url._DeclarationLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 102, 4
    )
    __url._UseLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 102, 4
    )
    ...
    _AttributeMap.update({__type.name(): __type, __url.name(): __url})
...
class referralType(pyxb.binding.basis.complexTypeDefinition):
    ...
    __referrer = pyxb.binding.content.AttributeUse(
        pyxb.namespace.ExpandedName(None, "referrer"),
        "referrer",
        "__urnvpropages2013_referralType_referrer",
        pyxb.binding.datatypes.string,
    )
    __referrer._DeclarationLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 108, 8
    )
    __referrer._UseLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 108, 8
    )
    ...
    __type = pyxb.binding.content.AttributeUse(
        pyxb.namespace.ExpandedName(None, "type"),
        "type",
        "__urnvpropages2013_referralType_type",
        _module_typeBindings.linkTypeEnum,
    )
    __type._DeclarationLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 109, 8
    )
    __type._UseLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 109, 8
    )
    ...
    _ElementMap.update({})
    _AttributeMap.update({__referrer.name(): __referrer, __type.name(): __type})
...
class linkType(pyxb.binding.basis.complexTypeDefinition):
    ...
    __text = pyxb.binding.content.ElementDeclaration(
        ...
        "text",
        "__urnvpropages2013_linkType_urnvpropages2013text",
        False,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 116, 6),
    )

    text = property(__text.value, __text.set, None, None)

    # Attribute pageRef uses Python identifier pageRef
    __pageRef = pyxb.binding.content.AttributeUse(
        pyxb.namespace.ExpandedName(None, "pageRef"),
        "pageRef",
        "__urnvpropages2013_linkType_pageRef",
        pyxb.binding.datatypes.string,
    )
    __pageRef._DeclarationLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 118, 4
    )
    __pageRef._UseLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 118, 4
    )
    ...
    __type = pyxb.binding.content.AttributeUse(
        pyxb.namespace.ExpandedName(None, "type"),
        "type",
        "__urnvpropages2013_linkType_type",
        _module_typeBindings.linkTypeEnum,
    )
    __type._DeclarationLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 119, 4
    )
    __type._UseLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 119, 4
    )
    ...
    _AttributeMap.update({__pageRef.name(): __pageRef, __type.name(): __type})
...
genre = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "genre"),
    genreType,
    location=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 7, 2),
)
Namespace.addCategoryObject("elementBinding", genre.name().localName(), genre)

page = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "page"),
    pageType,
    location=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 9, 2),
)
...
CTD_ANON._AddElement(
    pyxb.binding.basis.element(
        ...
        paragraphType,
        scope=CTD_ANON,
        location=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 25, 12),
    )
)
...
def _BuildAutomaton():
    ...
    cc_0 = fac.CounterCondition(
        min=0,
        max=None,
        metadata=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 25, 12),
    )
    counters.add(cc_0)
    states = []
    final_update = set()
    ...
    symbol = pyxb.binding.content.ElementUse(
        CTD_ANON._UseForTag(pyxb.namespace.ExpandedName(Namespace, "paragraph")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 25, 12),
    )
...
CTD_ANON_._AddElement(
    pyxb.binding.basis.element(
        ...
        imageType,
        scope=CTD_ANON_,
        location=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 37, 12),
    )
)
...
def _BuildAutomaton_():
    ...
    cc_0 = fac.CounterCondition(
        min=0,
        max=None,
        metadata=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 37, 12),
    )
    counters.add(cc_0)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(
        CTD_ANON_._UseForTag(pyxb.namespace.ExpandedName(Namespace, "image")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 37, 12),
    )
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
...
portalType._AddElement(
    pyxb.binding.basis.element(
        pyxb.namespace.ExpandedName(Namespace, "name"),
        pyxb.binding.datatypes.string,
        scope=portalType,
        location=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 57, 6),
    )
)
...
portalType._AddElement(
    pyxb.binding.basis.element(
        ...
        sectionType,
        scope=portalType,
        location=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 58, 6),
    )
)
...
def _BuildAutomaton_2():
    ...
    cc_0 = fac.CounterCondition(
        min=0,
        max=1,
        metadata=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 58, 6),
    )
    counters.add(cc_0)
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(
        portalType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "name")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 57, 6),
    )
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    ...
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(
        portalType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "section")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 58, 6),
    )
...
genreType._AddElement(
    pyxb.binding.basis.element(
        ...
        pageTermType,
        scope=genreType,
        location=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 74, 6),
    )
)
...
def _BuildAutomaton_3():
    ...
    cc_0 = fac.CounterCondition(
        min=0,
        max=None,
        metadata=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 74, 6),
    )
    counters.add(cc_0)
    states = []
    final_update = set()
...
paragraphType._AddElement(
    pyxb.binding.basis.element(
        pyxb.namespace.ExpandedName(Namespace, "title"),
        pyxb.binding.datatypes.string,
        scope=paragraphType,
        location=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 86, 6),
    )
)
...
paragraphType._AddElement(
    pyxb.binding.basis.element(
        ...
        pyxb.binding.datatypes.string,
        scope=paragraphType,
        location=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 87, 6),
    )
)
...
paragraphType._AddElement(
    pyxb.binding.basis.element(
        ...
        imageType,
        scope=paragraphType,
        location=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 88, 6),
    )
)
...
def _BuildAutomaton_4():
    ...
    cc_0 = fac.CounterCondition(
        min=0,
        max=1,
        metadata=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 86, 6),
    )
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(
        min=0,
        max=1,
        metadata=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 87, 6),
    )
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(
        min=0,
        max=1,
        metadata=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 88, 6),
    )
    counters.add(cc_2)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(
        paragraphType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "title")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 86, 6),
    )
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    ...
    symbol = pyxb.binding.content.ElementUse(
        paragraphType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "body")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 87, 6),
    )
    ...
    symbol = pyxb.binding.content.ElementUse(
        paragraphType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "image")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 88, 6),
    )
...
embedType._AddElement(
    pyxb.binding.basis.element(
        pyxb.namespace.ExpandedName(_Namespace_media, "program"),
        _ImportedBinding_npoapi_xml_media.programType,
        scope=embedType,
        documentation="\n        This is the most used entity in POMS. It represents e.g. one broadcast program or one web-only clip. It represent a standalone entity which a consumer can view or listen to.\n      ",
...
embedType._AddElement(
    pyxb.binding.basis.element(
        pyxb.namespace.ExpandedName(_Namespace_media, "group"),
        _ImportedBinding_npoapi_xml_media.groupType,
        scope=embedType,
        documentation="\n        A groups collects a number of programs and/or other groups. Examples: season, series, playlist and album.\n      ",
...
embedType._AddElement(
    pyxb.binding.basis.element(
        pyxb.namespace.ExpandedName(_Namespace_media, "segment"),
        _ImportedBinding_npoapi_xml_media.segmentType,
        scope=embedType,
        documentation="\n        A program can contain a number of segments. A segment is an identifiable part of a program.\n      ",
...
embedType._AddElement(
    pyxb.binding.basis.element(
        ...
        pyxb.binding.datatypes.string,
        scope=embedType,
        location=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 124, 6),
    )
)
...
embedType._AddElement(
    pyxb.binding.basis.element(
        ...
        pyxb.binding.datatypes.string,
        scope=embedType,
        location=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 125, 6),
    )
)
...
def _BuildAutomaton_5():
    ...
    cc_0 = fac.CounterCondition(
        min=0,
        max=1,
        metadata=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 124, 6),
    )
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(
        min=0,
        max=1,
        metadata=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 125, 6),
    )
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(
        min=0,
        max=1,
        metadata=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 126, 6),
    )
    counters.add(cc_2)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(
        embedType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "title")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 124, 6),
    )
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    ...
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(
        embedType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "description")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 125, 6),
    )
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    ...
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(
        embedType._UseForTag(pyxb.namespace.ExpandedName(_Namespace_media, "group")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 127, 8),
    )
    st_2 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(
        embedType._UseForTag(pyxb.namespace.ExpandedName(_Namespace_media, "program")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 128, 8),
    )
    ...
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(
        embedType._UseForTag(pyxb.namespace.ExpandedName(_Namespace_media, "segment")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 129, 8),
    )
...
pageType._AddElement(
    pyxb.binding.basis.element(
        ...
        pyxb.binding.datatypes.string,
        scope=pageType,
        location=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 13, 6),
    )
)
...
pageType._AddElement(
    pyxb.binding.basis.element(
        ...
        pyxb.binding.datatypes.string,
        scope=pageType,
        location=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 14, 6),
    )
)
...
pageType._AddElement(
    pyxb.binding.basis.element(
        pyxb.namespace.ExpandedName(Namespace, "broadcaster"),
        _ImportedBinding_npoapi_xml_media.broadcasterType,
        scope=pageType,
        location=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 15, 6),
    )
)
...
pageType._AddElement(
    pyxb.binding.basis.element(
        ...
        portalType,
        scope=pageType,
        location=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 16, 6),
    )
)
...
pageType._AddElement(
    pyxb.binding.basis.element(
        ...
        pyxb.binding.datatypes.string,
        scope=pageType,
        location=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 17, 6),
    )
)
...
pageType._AddElement(
    pyxb.binding.basis.element(
        ...
        pyxb.binding.datatypes.string,
        scope=pageType,
        location=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 18, 6),
    )
)
...
pageType._AddElement(
    pyxb.binding.basis.element(
        ...
        pyxb.binding.datatypes.string,
        scope=pageType,
        location=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 19, 6),
    )
)
...
pageType._AddElement(
    pyxb.binding.basis.element(
        ...
        pyxb.binding.datatypes.string,
        scope=pageType,
        location=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 21, 6),
    )
)
...
pageType._AddElement(
    pyxb.binding.basis.element(
        ...
        CTD_ANON,
        scope=pageType,
        location=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 22, 6),
    )
)
...
pageType._AddElement(
    pyxb.binding.basis.element(
        ...
        pyxb.binding.datatypes.string,
        scope=pageType,
        location=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 29, 6),
    )
)
...
pageType._AddElement(
    pyxb.binding.basis.element(
        ...
        referralType,
        scope=pageType,
        location=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 30, 6),
    )
)
...
pageType._AddElement(
    pyxb.binding.basis.element(
        ...
        linkType,
        scope=pageType,
        location=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 31, 6),
    )
)
...
pageType._AddElement(
    pyxb.binding.basis.element(
        ...
        embedType,
        scope=pageType,
        location=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 32, 6),
    )
)
...
pageType._AddElement(
    pyxb.binding.basis.element(
        ...
        pyxb.binding.datatypes.string,
        scope=pageType,
        location=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 33, 6),
    )
)
...
pageType._AddElement(
    pyxb.binding.basis.element(
        ...
        CTD_ANON_,
        scope=pageType,
        location=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 34, 6),
    )
)
...
pageType._AddElement(
    pyxb.binding.basis.element(
        ...
        relationType,
        scope=pageType,
        location=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 41, 6),
    )
)
...
def _BuildAutomaton_6():
    ...
    cc_0 = fac.CounterCondition(
        min=0,
        max=None,
        metadata=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 13, 6),
    )
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(
        min=0,
        max=None,
        metadata=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 14, 6),
    )
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(
        min=0,
        max=1,
        metadata=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 16, 6),
    )
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(
        min=0,
        max=1,
        metadata=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 18, 6),
    )
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(
        min=0,
        max=None,
        metadata=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 19, 6),
    )
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(
        min=0,
        max=None,
        metadata=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 20, 6),
    )
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(
        min=0,
        max=1,
        metadata=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 21, 6),
    )
    counters.add(cc_6)
    cc_7 = fac.CounterCondition(
        min=0,
        max=1,
        metadata=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 22, 6),
    )
    counters.add(cc_7)
    cc_8 = fac.CounterCondition(
        min=0,
        max=None,
        metadata=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 29, 6),
    )
    counters.add(cc_8)
    cc_9 = fac.CounterCondition(
        min=0,
        max=None,
        metadata=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 30, 6),
    )
    counters.add(cc_9)
    cc_10 = fac.CounterCondition(
        min=0,
        max=None,
        metadata=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 31, 6),
    )
    counters.add(cc_10)
    cc_11 = fac.CounterCondition(
        min=0,
        max=None,
        metadata=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 32, 6),
    )
    counters.add(cc_11)
    cc_12 = fac.CounterCondition(
        min=0,
        max=None,
        metadata=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 33, 6),
    )
    counters.add(cc_12)
    cc_13 = fac.CounterCondition(
        min=0,
        max=1,
        metadata=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 34, 6),
    )
    counters.add(cc_13)
    cc_14 = fac.CounterCondition(
        min=0,
        max=None,
        metadata=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 41, 6),
    )
    counters.add(cc_14)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        pageType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "crid")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 13, 6),
    )
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        pageType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "alternativeUrl")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 14, 6),
    )
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        pageType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "broadcaster")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 15, 6),
    )
    st_2 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        pageType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "portal")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 16, 6),
    )
    ...
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(
        pageType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "title")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 17, 6),
    )
    ...
    symbol = pyxb.binding.content.ElementUse(
        pageType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "subTitle")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 18, 6),
    )
    ...
    symbol = pyxb.binding.content.ElementUse(
        pageType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "keyword")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 19, 6),
    )
    ...
    symbol = pyxb.binding.content.ElementUse(
        pageType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "genre")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 20, 6),
    )
    ...
    symbol = pyxb.binding.content.ElementUse(
        pageType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "summary")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 21, 6),
    )
    ...
    symbol = pyxb.binding.content.ElementUse(
        pageType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "paragraphs")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 22, 6),
    )
    ...
    symbol = pyxb.binding.content.ElementUse(
        pageType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "tag")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 29, 6),
    )
    ...
    symbol = pyxb.binding.content.ElementUse(
        pageType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "referral")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 30, 6),
    )
    ...
    symbol = pyxb.binding.content.ElementUse(
        pageType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "link")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 31, 6),
    )
    ...
    symbol = pyxb.binding.content.ElementUse(
        pageType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "embed")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 32, 6),
    )
    ...
    symbol = pyxb.binding.content.ElementUse(
        pageType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "statRef")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 33, 6),
    )
    ...
    symbol = pyxb.binding.content.ElementUse(
        pageType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "images")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 34, 6),
    )
    ...
    symbol = pyxb.binding.content.ElementUse(
        pageType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "relation")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 41, 6),
    )
...
imageType._AddElement(
    pyxb.binding.basis.element(
        ...
        pyxb.binding.datatypes.string,
        scope=imageType,
        location=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 94, 6),
    )
)
...
imageType._AddElement(
    pyxb.binding.basis.element(
        ...
        pyxb.binding.datatypes.string,
        scope=imageType,
        location=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 95, 6),
    )
)
...
imageType._AddElement(
    pyxb.binding.basis.element(
        ...
        pyxb.binding.datatypes.string,
        scope=imageType,
        location=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 96, 6),
    )
)
...
imageType._AddElement(
    pyxb.binding.basis.element(
        ...
        pyxb.binding.datatypes.string,
        scope=imageType,
        location=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 97, 6),
    )
)
...
imageType._AddElement(
    pyxb.binding.basis.element(
        ...
        pyxb.binding.datatypes.string,
        scope=imageType,
        location=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 98, 6),
    )
)
...
imageType._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=imageType,
        location=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 99, 6),
    )
)
...
def _BuildAutomaton_7():
    ...
    cc_0 = fac.CounterCondition(
        min=0,
        max=1,
        metadata=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 94, 6),
    )
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(
        min=0,
        max=1,
        metadata=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 95, 6),
    )
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(
        min=0,
        max=1,
        metadata=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 96, 6),
    )
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(
        min=0,
        max=1,
        metadata=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 97, 6),
    )
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(
        min=0,
        max=1,
        metadata=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 98, 6),
    )
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(
        min=0,
        max=1,
        metadata=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 99, 6),
    )
    counters.add(cc_5)
    states = []
    final_update = set()
...
linkType._AddElement(
    pyxb.binding.basis.element(
        ...
        pyxb.binding.datatypes.string,
        scope=linkType,
        location=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 116, 6),
    )
)
...
def _BuildAutomaton_8():
    ...
    cc_0 = fac.CounterCondition(
        min=0,
        max=1,
        metadata=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 116, 6),
    )
    counters.add(cc_0)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(
        linkType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "text")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:2013", 116, 6),
    )
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
