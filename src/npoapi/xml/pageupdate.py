...
class CTD_ANON(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 22, 8
    )
    _ElementMap = {}
    _AttributeMap = {}
    ...
    __paragraph = pyxb.binding.content.ElementDeclaration(
        ...
        "paragraph",
        "__urnvpropagesupdate2013_CTD_ANON_urnvpropagesupdate2013paragraph",
        True,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 24, 12),
    )
...
class CTD_ANON_(pyxb.binding.basis.complexTypeDefinition):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 32, 8
    )
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __embed = pyxb.binding.content.ElementDeclaration(
        ...
        "embed",
        "__urnvpropagesupdate2013_CTD_ANON__urnvpropagesupdate2013embed",
        True,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 34, 12),
    )

    embed = property(__embed.value, __embed.set, None, None)

    _ElementMap.update({__embed.name(): __embed})
    _AttributeMap.update({})
...
class portalUpdateType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 51, 2
    )
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __section = pyxb.binding.content.ElementDeclaration(
        ...
        "section",
        "__urnvpropagesupdate2013_portalUpdateType_urnvpropagesupdate2013section",
        False,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 53, 6),
    )
    ...
    __id = pyxb.binding.content.AttributeUse(
        ...
        "id",
        "__urnvpropagesupdate2013_portalUpdateType_id",
        pyxb.binding.datatypes.string,
        required=True,
    )
    __id._DeclarationLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 55, 4
    )
    ...
    __url = pyxb.binding.content.AttributeUse(
        ...
        "url",
        "__urnvpropagesupdate2013_portalUpdateType_url",
        pyxb.binding.datatypes.string,
        required=True,
    )
    __url._DeclarationLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 56, 4
    )
    ...
    _ElementMap.update({__section.name(): __section})
...
class paragraphUpdateType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 59, 2
    )
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __image = pyxb.binding.content.ElementDeclaration(
        ...
        "image",
        "__urnvpropagesupdate2013_paragraphUpdateType_urnvpropagesupdate2013image",
        False,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 7, 2),
    )
    ...
    __title = pyxb.binding.content.ElementDeclaration(
        ...
        "title",
        "__urnvpropagesupdate2013_paragraphUpdateType_urnvpropagesupdate2013title",
        False,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 61, 6),
    )
    ...
    __body = pyxb.binding.content.ElementDeclaration(
        ...
        "body",
        "__urnvpropagesupdate2013_paragraphUpdateType_urnvpropagesupdate2013body",
        False,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 62, 6),
    )

    body = property(__body.value, __body.set, None, None)

    _ElementMap.update({__image.name(): __image, __title.name(): __title, __body.name(): __body})
    _AttributeMap.update({})
...
class imageLocationType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 80, 2
    )
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __url = pyxb.binding.content.ElementDeclaration(
        ...
        "url",
        "__urnvpropagesupdate2013_imageLocationType_urnvpropagesupdate2013url",
        False,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 82, 6),
    )
...
class embedUpdateType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 94, 2
    )
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __title = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "title"),
        "title",
        "__urnvpropagesupdate2013_embedUpdateType_urnvpropagesupdate2013title",
        False,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 96, 6),
    )
    ...
    __description = pyxb.binding.content.ElementDeclaration(
        ...
        "description",
        "__urnvpropagesupdate2013_embedUpdateType_urnvpropagesupdate2013description",
        False,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 97, 6),
    )
    ...
    __midRef = pyxb.binding.content.AttributeUse(
        ...
        "midRef",
        "__urnvpropagesupdate2013_embedUpdateType_midRef",
        pyxb.binding.datatypes.string,
    )
    __midRef._DeclarationLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 99, 4
    )
    ...
    _ElementMap.update({__title.name(): __title, __description.name(): __description})
    _AttributeMap.update({__midRef.name(): __midRef})
...
class relationUpdateType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 102, 2
    )
    _ElementMap = {}
    _AttributeMap = {}
    ...
    __type = pyxb.binding.content.AttributeUse(
        ...
        "type",
        "__urnvpropagesupdate2013_relationUpdateType_type",
        pyxb.binding.datatypes.string,
        required=True,
    )
    __type._DeclarationLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 105, 8
    )
    ...
    __broadcaster = pyxb.binding.content.AttributeUse(
        ...
        "broadcaster",
        "__urnvpropagesupdate2013_relationUpdateType_broadcaster",
        pyxb.binding.datatypes.string,
        required=True,
    )
    __broadcaster._DeclarationLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 106, 8
    )
    ...
    __uriRef = pyxb.binding.content.AttributeUse(
        ...
        "uriRef",
        "__urnvpropagesupdate2013_relationUpdateType_uriRef",
        pyxb.binding.datatypes.string,
    )
    __uriRef._DeclarationLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 107, 8
    )
...
class pageUpdateType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 11, 2
    )
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __image = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "image"),
        "image",
        "__urnvpropagesupdate2013_pageUpdateType_urnvpropagesupdate2013image",
        True,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 7, 2),
    )
    ...
    __crid = pyxb.binding.content.ElementDeclaration(
        ...
        "crid",
        "__urnvpropagesupdate2013_pageUpdateType_urnvpropagesupdate2013crid",
        True,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 13, 6),
    )
    ...
    __alternativeUrl = pyxb.binding.content.ElementDeclaration(
        ...
        "alternativeUrl",
        "__urnvpropagesupdate2013_pageUpdateType_urnvpropagesupdate2013alternativeUrl",
        True,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 14, 6),
    )
    ...
    __broadcaster = pyxb.binding.content.ElementDeclaration(
        ...
        "broadcaster",
        "__urnvpropagesupdate2013_pageUpdateType_urnvpropagesupdate2013broadcaster",
        True,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 15, 6),
    )
    ...
    __portal = pyxb.binding.content.ElementDeclaration(
        ...
        "portal",
        "__urnvpropagesupdate2013_pageUpdateType_urnvpropagesupdate2013portal",
        False,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 16, 6),
    )
    ...
    __title = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "title"),
        "title",
        "__urnvpropagesupdate2013_pageUpdateType_urnvpropagesupdate2013title",
        False,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 17, 6),
    )
    ...
    __subtitle = pyxb.binding.content.ElementDeclaration(
        ...
        "subtitle",
        "__urnvpropagesupdate2013_pageUpdateType_urnvpropagesupdate2013subtitle",
        False,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 18, 6),
    )
    ...
    __keyword = pyxb.binding.content.ElementDeclaration(
        ...
        "keyword",
        "__urnvpropagesupdate2013_pageUpdateType_urnvpropagesupdate2013keyword",
        True,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 19, 6),
    )
    ...
    __summary = pyxb.binding.content.ElementDeclaration(
        ...
        "summary",
        "__urnvpropagesupdate2013_pageUpdateType_urnvpropagesupdate2013summary",
        False,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 20, 6),
    )
    ...
    __paragraphs = pyxb.binding.content.ElementDeclaration(
        ...
        "paragraphs",
        "__urnvpropagesupdate2013_pageUpdateType_urnvpropagesupdate2013paragraphs",
        False,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 21, 6),
    )
    ...
    __tag = pyxb.binding.content.ElementDeclaration(
        ...
        "tag",
        "__urnvpropagesupdate2013_pageUpdateType_urnvpropagesupdate2013tag",
        True,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 28, 6),
    )
    ...
    __genre = pyxb.binding.content.ElementDeclaration(
        ...
        "genre",
        "__urnvpropagesupdate2013_pageUpdateType_urnvpropagesupdate2013genre",
        True,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 29, 6),
    )
    ...
    genre = property(
        ...
        __genre.set,
        None,
        "Genres, as specified in https://publish.pages.omroep.nl/schema/classification",
    )
    ...
    __link = pyxb.binding.content.ElementDeclaration(
        ...
        "link",
        "__urnvpropagesupdate2013_pageUpdateType_urnvpropagesupdate2013link",
        True,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 30, 6),
    )

    link = property(__link.value, __link.set, None, None)

    # Element {urn:vpro:pages:update:2013}embeds uses Python identifier embeds
    __embeds = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "embeds"),
        "embeds",
        "__urnvpropagesupdate2013_pageUpdateType_urnvpropagesupdate2013embeds",
        False,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 31, 6),
    )
    ...
    __statRef = pyxb.binding.content.ElementDeclaration(
        ...
        "statRef",
        "__urnvpropagesupdate2013_pageUpdateType_urnvpropagesupdate2013statRef",
        True,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 38, 6),
    )
    ...
    __relation = pyxb.binding.content.ElementDeclaration(
        ...
        "relation",
        "__urnvpropagesupdate2013_pageUpdateType_urnvpropagesupdate2013relation",
        True,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 40, 6),
    )
    ...
    __type = pyxb.binding.content.AttributeUse(
        pyxb.namespace.ExpandedName(None, "type"),
        "type",
        "__urnvpropagesupdate2013_pageUpdateType_type",
        _ImportedBinding_npoapi_xml_page.pageTypeEnum,
        required=True,
    )
    __type._DeclarationLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 42, 4
    )
    __type._UseLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 42, 4
    )
    ...
    __url = pyxb.binding.content.AttributeUse(
        pyxb.namespace.ExpandedName(None, "url"),
        "url",
        "__urnvpropagesupdate2013_pageUpdateType_url",
        pyxb.binding.datatypes.string,
        required=True,
    )
    __url._DeclarationLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 43, 4
    )
    __url._UseLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 43, 4
    )
    ...
    __publishStart = pyxb.binding.content.AttributeUse(
        ...
        "publishStart",
        "__urnvpropagesupdate2013_pageUpdateType_publishStart",
        pyxb.binding.datatypes.dateTime,
    )
    __publishStart._DeclarationLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 44, 4
    )
    ...
    __lastPublished._DeclarationLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 45, 4
    )
    ...
    __creationDate = pyxb.binding.content.AttributeUse(
        ...
        "creationDate",
        "__urnvpropagesupdate2013_pageUpdateType_creationDate",
        pyxb.binding.datatypes.dateTime,
    )
    __creationDate._DeclarationLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 46, 4
    )
    ...
    __lastModified = pyxb.binding.content.AttributeUse(
        ...
        "lastModified",
        "__urnvpropagesupdate2013_pageUpdateType_lastModified",
        pyxb.binding.datatypes.dateTime,
    )
    __lastModified._DeclarationLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 47, 4
    )
    ...
    __workflow = pyxb.binding.content.AttributeUse(
        ...
        "workflow",
        "__urnvpropagesupdate2013_pageUpdateType_workflow",
        _ImportedBinding_npoapi_xml_page.pageWorkflow,
    )
    __workflow._DeclarationLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 48, 4
    )
...
class imageUpdateType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 67, 2
    )
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __title = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "title"),
        "title",
        "__urnvpropagesupdate2013_imageUpdateType_urnvpropagesupdate2013title",
        False,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 69, 6),
    )
    ...
    __description = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "description"),
        "description",
        "__urnvpropagesupdate2013_imageUpdateType_urnvpropagesupdate2013description",
        False,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 70, 6),
    )
    ...
    __source = pyxb.binding.content.ElementDeclaration(
        ...
        "source",
        "__urnvpropagesupdate2013_imageUpdateType_urnvpropagesupdate2013source",
        False,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 71, 6),
    )
    ...
    __sourceName = pyxb.binding.content.ElementDeclaration(
        ...
        "sourceName",
        "__urnvpropagesupdate2013_imageUpdateType_urnvpropagesupdate2013sourceName",
        False,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 72, 6),
    )
    ...
    __license = pyxb.binding.content.ElementDeclaration(
        ...
        "license",
        "__urnvpropagesupdate2013_imageUpdateType_urnvpropagesupdate2013license",
        False,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 73, 6),
    )
    ...
    __credits = pyxb.binding.content.ElementDeclaration(
        ...
        "credits",
        "__urnvpropagesupdate2013_imageUpdateType_urnvpropagesupdate2013credits",
        False,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 74, 6),
    )
    ...
    __imageLocation = pyxb.binding.content.ElementDeclaration(
        ...
        "imageLocation",
        "__urnvpropagesupdate2013_imageUpdateType_urnvpropagesupdate2013imageLocation",
        False,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 75, 6),
    )
    ...
    __type = pyxb.binding.content.AttributeUse(
        pyxb.namespace.ExpandedName(None, "type"),
        "type",
        "__urnvpropagesupdate2013_imageUpdateType_type",
        _ImportedBinding_npoapi_xml_shared.imageTypeEnum,
        required=True,
    )
    __type._DeclarationLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 77, 4
    )
    __type._UseLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 77, 4
    )
...
class linkUpdateType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 86, 2
    )
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __text = pyxb.binding.content.ElementDeclaration(
        ...
        "text",
        "__urnvpropagesupdate2013_linkUpdateType_urnvpropagesupdate2013text",
        False,
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 88, 6),
    )
    ...
    __pageRef = pyxb.binding.content.AttributeUse(
        ...
        "pageRef",
        "__urnvpropagesupdate2013_linkUpdateType_pageRef",
        pyxb.binding.datatypes.string,
    )
    __pageRef._DeclarationLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 90, 4
    )
    ...
    __type = pyxb.binding.content.AttributeUse(
        pyxb.namespace.ExpandedName(None, "type"),
        "type",
        "__urnvpropagesupdate2013_linkUpdateType_type",
        _ImportedBinding_npoapi_xml_page.linkTypeEnum,
    )
    __type._DeclarationLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 91, 4
    )
    __type._UseLocation = pyxb.utils.utility.Location(
        "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 91, 4
    )
...
image = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "image"),
    imageUpdateType,
    location=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 7, 2),
)
...
page = pyxb.binding.basis.element(
    ...
    pageUpdateType,
    location=pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 9, 2),
)
...
CTD_ANON._AddElement(
    pyxb.binding.basis.element(
        ...
        location=pyxb.utils.utility.Location(
            "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 24, 12
        ),
    )
)
...
CTD_ANON_._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=CTD_ANON_,
        location=pyxb.utils.utility.Location(
            "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 34, 12
        ),
    )
)
...
def _BuildAutomaton_():
    ...
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(
        CTD_ANON_._UseForTag(pyxb.namespace.ExpandedName(Namespace, "embed")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 34, 12),
    )
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
...
portalUpdateType._AddElement(
    pyxb.binding.basis.element(
        pyxb.namespace.ExpandedName(Namespace, "section"),
        _ImportedBinding_npoapi_xml_page.sectionType,
        scope=portalUpdateType,
        location=pyxb.utils.utility.Location(
            "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 53, 6
        ),
    )
)
...
def _BuildAutomaton_2():
    ...
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(
        portalUpdateType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "section")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 53, 6),
    )
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
...
paragraphUpdateType._AddElement(
    pyxb.binding.basis.element(
        pyxb.namespace.ExpandedName(Namespace, "image"),
        imageUpdateType,
        scope=paragraphUpdateType,
        location=pyxb.utils.utility.Location(
            "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 7, 2
        ),
    )
)
...
paragraphUpdateType._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=paragraphUpdateType,
        location=pyxb.utils.utility.Location(
            "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 61, 6
        ),
    )
)
...
paragraphUpdateType._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=paragraphUpdateType,
        location=pyxb.utils.utility.Location(
            "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 62, 6
        ),
    )
)
...
def _BuildAutomaton_3():
    ...
    cc_2 = fac.CounterCondition(
        ...
        max=1,
        metadata=pyxb.utils.utility.Location(
            "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 63, 6
        ),
    )
    counters.add(cc_2)
    states = []
    ...
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(
        paragraphUpdateType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "title")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 61, 6),
    )
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    ...
    symbol = pyxb.binding.content.ElementUse(
        paragraphUpdateType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "body")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 62, 6),
    )
    ...
    symbol = pyxb.binding.content.ElementUse(
        paragraphUpdateType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "image")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 63, 6),
    )
...
imageLocationType._AddElement(
    pyxb.binding.basis.element(
        ...
        location=pyxb.utils.utility.Location(
            "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 82, 6
        ),
    )
)
...
embedUpdateType._AddElement(
    pyxb.binding.basis.element(
        pyxb.namespace.ExpandedName(Namespace, "title"),
        pyxb.binding.datatypes.string,
        scope=embedUpdateType,
        location=pyxb.utils.utility.Location(
            "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 96, 6
        ),
    )
)
...
embedUpdateType._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=embedUpdateType,
        location=pyxb.utils.utility.Location(
            "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 97, 6
        ),
    )
)
...
def _BuildAutomaton_5():
    ...
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(
        embedUpdateType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "title")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 96, 6),
    )
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    ...
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(
        embedUpdateType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "description")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 97, 6),
    )
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
...
pageUpdateType._AddElement(
    pyxb.binding.basis.element(
        pyxb.namespace.ExpandedName(Namespace, "image"),
        imageUpdateType,
        scope=pageUpdateType,
        location=pyxb.utils.utility.Location(
            "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 7, 2
        ),
    )
...
pageUpdateType._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=pageUpdateType,
        location=pyxb.utils.utility.Location(
            "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 13, 6
        ),
    )
)
...
pageUpdateType._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=pageUpdateType,
        location=pyxb.utils.utility.Location(
            "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 14, 6
        ),
    )
)
...
pageUpdateType._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=pageUpdateType,
        location=pyxb.utils.utility.Location(
            "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 15, 6
        ),
    )
)
...
pageUpdateType._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=pageUpdateType,
        location=pyxb.utils.utility.Location(
            "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 16, 6
        ),
    )
)
...
pageUpdateType._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=pageUpdateType,
        location=pyxb.utils.utility.Location(
            "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 17, 6
        ),
    )
)
...
pageUpdateType._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=pageUpdateType,
        location=pyxb.utils.utility.Location(
            "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 18, 6
        ),
    )
)
...
pageUpdateType._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=pageUpdateType,
        location=pyxb.utils.utility.Location(
            "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 19, 6
        ),
    )
)
...
pageUpdateType._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=pageUpdateType,
        location=pyxb.utils.utility.Location(
            "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 20, 6
        ),
    )
)
...
pageUpdateType._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=pageUpdateType,
        location=pyxb.utils.utility.Location(
            "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 21, 6
        ),
    )
)
...
pageUpdateType._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=pageUpdateType,
        location=pyxb.utils.utility.Location(
            "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 28, 6
        ),
    )
)
...
pageUpdateType._AddElement(
    pyxb.binding.basis.element(
        ...
        pyxb.binding.datatypes.string,
        scope=pageUpdateType,
        documentation="Genres, as specified in https://publish.pages.omroep.nl/schema/classification",
        location=pyxb.utils.utility.Location(
            "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 29, 6
        ),
    )
)
...
pageUpdateType._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=pageUpdateType,
        location=pyxb.utils.utility.Location(
            "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 30, 6
        ),
    )
)
...
pageUpdateType._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=pageUpdateType,
        location=pyxb.utils.utility.Location(
            "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 31, 6
        ),
    )
)
...
pageUpdateType._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=pageUpdateType,
        location=pyxb.utils.utility.Location(
            "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 38, 6
        ),
    )
)
...
pageUpdateType._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=pageUpdateType,
        location=pyxb.utils.utility.Location(
            "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 40, 6
        ),
    )
)
...
def _BuildAutomaton_6():
    ...
    cc_12 = fac.CounterCondition(
        ...
        max=None,
        metadata=pyxb.utils.utility.Location(
            "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 39, 6
        ),
    )
    counters.add(cc_12)
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        pageUpdateType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "crid")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 13, 6),
    )
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        pageUpdateType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "alternativeUrl")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 14, 6),
    )
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        pageUpdateType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "broadcaster")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 15, 6),
    )
    st_2 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        pageUpdateType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "portal")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 16, 6),
    )
    ...
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(
        pageUpdateType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "title")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 17, 6),
    )
    ...
    symbol = pyxb.binding.content.ElementUse(
        pageUpdateType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "subtitle")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 18, 6),
    )
    ...
    symbol = pyxb.binding.content.ElementUse(
        pageUpdateType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "keyword")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 19, 6),
    )
    ...
    symbol = pyxb.binding.content.ElementUse(
        pageUpdateType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "summary")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 20, 6),
    )
    ...
    symbol = pyxb.binding.content.ElementUse(
        pageUpdateType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "paragraphs")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 21, 6),
    )
    ...
    symbol = pyxb.binding.content.ElementUse(
        pageUpdateType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "tag")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 28, 6),
    )
    ...
    symbol = pyxb.binding.content.ElementUse(
        pageUpdateType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "genre")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 29, 6),
    )
    ...
    symbol = pyxb.binding.content.ElementUse(
        pageUpdateType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "link")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 30, 6),
    )
    ...
    symbol = pyxb.binding.content.ElementUse(
        pageUpdateType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "embeds")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 31, 6),
    )
    ...
    symbol = pyxb.binding.content.ElementUse(
        pageUpdateType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "statRef")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 38, 6),
    )
    ...
    symbol = pyxb.binding.content.ElementUse(
        pageUpdateType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "image")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 39, 6),
    )
    ...
    symbol = pyxb.binding.content.ElementUse(
        pageUpdateType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "relation")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 40, 6),
    )
...
imageUpdateType._AddElement(
    pyxb.binding.basis.element(
        ...
        location=pyxb.utils.utility.Location(
            "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 69, 6
        ),
    )
)
...
imageUpdateType._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=imageUpdateType,
        location=pyxb.utils.utility.Location(
            "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 70, 6
        ),
    )
)
...
imageUpdateType._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=imageUpdateType,
        location=pyxb.utils.utility.Location(
            "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 71, 6
        ),
    )
)
...
imageUpdateType._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=imageUpdateType,
        location=pyxb.utils.utility.Location(
            "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 72, 6
        ),
    )
)
...
imageUpdateType._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=imageUpdateType,
        location=pyxb.utils.utility.Location(
            "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 73, 6
        ),
    )
)
...
imageUpdateType._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=imageUpdateType,
        location=pyxb.utils.utility.Location(
            "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 74, 6
        ),
    )
)
...
imageUpdateType._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=imageUpdateType,
        location=pyxb.utils.utility.Location(
            "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 75, 6
        ),
    )
)
...
linkUpdateType._AddElement(
    pyxb.binding.basis.element(
        pyxb.namespace.ExpandedName(Namespace, "text"),
        pyxb.binding.datatypes.string,
        scope=linkUpdateType,
        location=pyxb.utils.utility.Location(
            "https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 88, 6
        ),
    )
)
...
def _BuildAutomaton_8():
    ...
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(
        linkUpdateType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "text")),
        pyxb.utils.utility.Location("https://rs-test.poms.omroep.nl/v1/schema/urn:vpro:pages:update:2013", 88, 6),
    )
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
